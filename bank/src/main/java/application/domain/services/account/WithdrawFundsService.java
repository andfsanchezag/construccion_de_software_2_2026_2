...
public class WithdrawFundsService implements WithdrawFundsUseCase {
    ...
    public BankAccount withdraw(User requestingUser, Customer customer, BankAccount account, Money amount) {
        ...
        Customer involvedCustomer = validateWithdrawalAccess(requestingUser, customer, stored);

        BigDecimal balanceBefore = stored.getCurrentBalance();
        stored.withdraw(amount);

        bankAccountRepositoryPort.update(stored);
        registerWithdrawalOperation(requestingUser, stored, amount, balanceBefore, involvedCustomer);
        return stored;
    }
    ...
    private Customer validateWithdrawalAccess(User user, Customer customer, BankAccount stored) {
    ...
    private void registerWithdrawalOperation(User user, BankAccount account, Money amount,
